                                                ...
                                                <td>                            
                                                    ...
                                                    <div class="dropdown">
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">                                                        
                                                            <a class="dropdown-item" href="{{url('Shop/'.$shop->name)}}">{{ __('View') }}</a>
                                                            <a class="dropdown-item" href="{{url('Shop/'.$shop->id.'/edit')}}">{{ __('Edit') }}</a>
                                                            <a class="dropdown-item" onclick="deleteData('Shop','{{$shop->id}}');" href="#">{{ __('Delete') }}</a>
