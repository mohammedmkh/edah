            ...
            <div class="row">
                    <div class="col-xl-12 order-xl-1">
                        <div class="card form-card bg-secondary shadow">
                            ...
                            <div class="card-body">
                                <form method="post" action="{{url(adminPath().'updateStoreUser')}}" autocomplete="off"  enctype="multipart/form-data">
                                    @csrf
                                    ...
                                    <div class="pl-lg-4">
                                       ...
                                       @endforeach
                                        ...
                                        <div class="form-group{{ $errors->has('identity') ? ' has-danger' : '' }}">
                                            ...
                                            <input type="text" name="identity" id="input-password" class="form-control form-control-alternative{{ $errors->has('identity') ? ' is-invalid' : '' }}" placeholder="{{ __('identity') }}" value="{{ old('phone', $data->identity) }}" required>
                                        ...
                                        <div class="form-group {{ $errors->has('hour_work') ? ' has-danger' : '' }}">
                                            ...
                                            <input type="text" name="hour_work" id="input-hour_work" class="form-control form-control-alternative{{ $errors->has('hour_work') ? ' is-invalid' : '' }}" placeholder="{{ __('Hour Work') }}" value="{{ old('hour_work', $data->hour_work) }}" required>
                                        ...
                                        <div class="form-group {{ $errors->has('min_order_value') ? ' has-danger' : '' }}">
                                            ...
                                            <input type="text" name="min_order_value" id="input-hour_work" class="form-control form-control-alternative{{ $errors->has('min_order_value') ? ' is-invalid' : '' }}" placeholder="{{ __('min order value') }}" value="{{ old('min_order_value', $data->min_order_value) }}" required>
                                        ...
                                        <div class="col-6">
                                            <div class="form-group {{ $errors->has('priority') ? ' has-danger' : '' }}">
                                                ...
                                                <input type="text" name="priority" id="input-hour_work" class="form-control form-control-alternative{{ $errors->has('priority') ? ' is-invalid' : '' }}" placeholder="{{ __('priority') }}" value="{{ old('priority', $data->priority) }}" required >
                                            </div>
                                        </div>
                                        <div class="col-6">
                                            <div class="form-group {{ $errors->has('app_benifit_percentage') ? ' has-danger' : '' }}">
                                                ...
                                                <input type="text" name="app_benifit_percentage" id="input-hour_work" class="form-control form-control-alternative{{ $errors->has('app_benifit_percentage') ? ' is-invalid' : '' }}" placeholder="{{ __('app benifit percentage') }}" value="{{ old('app_benifit_percentage', $data->app_benifit_percentage) }}" required >
                                            </div>
                                        </div>
                                        </div>
