        ...
        <div class="row">
            <div class="col-xl-12 order-xl-1">
                <div class="card form-card bg-secondary shadow">
                    ...
                    <div class="card-body">
                        <form method="post" action="{{url(adminPath().'updateTechnican')}}" autocomplete="off"
                            ...
                            <div class="pl-lg-4">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-6 ">
                                            ...
                                            <div style="margin-top: 40px">
                                                <a href="{{ url('/').'/'.$is_documents_has->document_link }}"> link to
                                                    download </a>
                                            </div>
                                            <?php
                                            }else{
                                ...
                                <div class="col-12">
                                    <div class="col-4"><label class="form-control-label">{{ __('Have Vehicle') }}
                                            :</label></div>
                                    <div class="col-8">
