                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="{{url('Location')}}">
                            <i class="ni ni-pin-3 " style="color: #ff9200;"></i> {{ __('Locations') }}
                                ...
                                <li class="nav-item">
                                    <a class="nav-link active" href="#navbar-examples_2" data-toggle="collapse"
                                       role="button"
                                        ...
                                        <ul class="nav nav-sm flex-column">
                                            <li class="nav-item">
                                                <a class="nav-link" href="{{url(adminPath().'Category')}}">
                                                    <i class="ni ni-app "
                                                       style="color: #f3a4b5;"></i> {{ __('Category') }}
                                                </a>
                                            </li>
                                            <li class="nav-item">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="{{url('Banner')}}">
                            ...
                            --->
                                ...
                                <li class="nav-item">
                                    ...
                                    <div class="collapse" id="navbar-examples">
                                        <ul class="nav nav-sm flex-column">
                                            <li class="nav-item">
                                                <a class="nav-link" href="{{url(adminPath().'Customer')}}">
                                                    <i class="fas fa-users"
                                                       style="color:#8abf4d;"></i> {{ __('Customers') }}
                                                </a>
                                            </li>
                                            ...
                                            <li class="nav-item">
                                                <a class="nav-link" href="{{url(adminPath().'adminusers')}}">
                                                    <i class="fas fa-truck-moving" style="color:#8abf4d;"></i>
                                                    {{ __('Admin Users') }}
                                                </a>
                                            </li>
                                ...
                                <li class="nav-item">
                                    <a class="nav-link active" href="#report-expand" data-toggle="collapse"
                                       role="button"
                                            ...
                                            <li class="nav-item">
                                                <a class="nav-link" href="{{url(adminPath().'cities')}}">
                                                    <i class="ni ni-paper-diploma"
                                                       style="color:#ff9200;"></i> {{ __('Cities') }}
                                                </a>
                                            </li>
                                            <li class="nav-item">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" href="{{url(adminPath().'notifications')}}">
                                        <i class="ni ni-app text-success"></i> {{ __('Notifications') }}
                                    </a>
                                </li>
