                        ...
                        <div class="card form-card bg-secondary shadow">
                            <div class="card-header bg-white border-0">
                                <div class="row align-items-center">
                                    <div class="col-8">
                                        <h3 class="mb-0">{{ __('Add New Document') }}</h3>
                                    </div>
                                    <div class="col-4 text-right">
                                        <a href="{{ url('documents') }}" class="btn btn-sm btn-primary">{{ __('Back to list') }}</a>
                                    </div>
                                </div>
                            </div>
                            <div class="card-body">
                                <form method="post" action="{{url('documents')}}" autocomplete="off" enctype="multipart/form-data" >
                                    @csrf
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-6">
                                                <div class="form-group{{ $errors->has('document_description') ? ' has-danger' : '' }}">
                                                        ...
                                                        <input type="text" name="document_description" id="input-name" class="form-control form-control-alternative{{ $errors->has('document_description') ? ' is-invalid' : '' }}" placeholder="{{ __('Name') }}" value="{{ old('name') }}" required autofocus>
                                            ...
                                            <div class="col-6">
                                                <div class="form-group{{ $errors->has('type') ? ' has-danger' : '' }}">
                                                    ...
                                                    <select name="type" id="input-shop_id" class="form-control form-control-alternative{{ $errors->has('country_id') ? ' is-invalid' : '' }}"required>
                                                        ...
                                                        <option value="2">صاحب محل </option>
                                                    </select>
                                            ...
                                            <div class="col-12">
                                                ...
                                                <div class="col-8">
                                                    <label class="custom-toggle">
                                                        <input type="checkbox" value="1" name="is_required" id="user_verify" checked>
