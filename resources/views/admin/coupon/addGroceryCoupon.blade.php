                                ...
                                <form method="post" id="add-coupon-form" action="{{url('GroceryCoupon')}}" autocomplete="off" enctype="multipart/form-data" >
                                    ...
                                    <div class="pl-lg-4">
                                        ...
                                        <div class="form-group{{ $errors->has('total_apply') ? ' has-danger' : '' }}">
                                            ...
                                            <input name="total_apply" id="input-total_apply" class="form-control form-control-alternative{{ $errors->has('total_apply') ? ' is-invalid' : '' }}" placeholder="{{ __('Total Apply The Discount') }}" value="{{ old('total_apply') }}" >
