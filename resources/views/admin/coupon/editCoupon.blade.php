                            ...
                            <div class="card-body">
                                ...
                                <form method="post" id="add-coupon-form" action="{{url(adminPath().'Coupon/'.$data->id)}}" autocomplete="off" enctype="multipart/form-data" >
                                    ...
                                    <div class="pl-lg-4">
                                        ...
                                        <div class="form-group{{ $errors->has('total_apply') ? ' has-danger' : '' }}">
                                            <label class="form-control-label" for="input-description">{{ __('Total Apply The Discount') }}</label>
                                            <input name="total_apply" id="input-total_apply" class="form-control form-control-alternative{{ $errors->has('total_apply') ? ' is-invalid' : '' }}" placeholder="{{ __('Total Apply The Discount') }}" value="{{ old('total_apply' ,$data->total_apply ) }}" >
                                            @if ($errors->has('total_apply'))
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $errors->first('total_apply') }}</strong>
                                                </span>
                                            @endif
                                        </div>
                                        <div class="row">
                                            ...
                                            <div class="col-6">                                              
                                                <div class="form-group{{ $errors->has('status') ? ' has-danger' : '' }}">
                                                        ...
                                                        <Select name="status" id="input-status" class="form-control form-control-alternative{{ $errors->has('status') ? ' is-invalid' : '' }}"  required>
                                                            ...
                                                            <option value="0" {{ $data->status=="0" ? 'Selected' : ''}}>{{ __('Active') }}</option>
                                                            <option value="1" {{ $data->status=="1" ? 'Selected' : ''}}>{{ __('Deactive') }}</option>
                                                        </select>
