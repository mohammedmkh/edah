                                    ...
                                    <tbody>
                                        @foreach ($shops as $shop)
                                            ...
                                            <tr>
                                                ...
                                                <td>{{$shop->user?$shop->user->name:'-'}}</td>
                                                <td>
                                                ...
                                                <td>                            
                                                    ...
                                                    <div class="dropdown">
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
                                                            <a class="dropdown-item" href="{{url('AdminShop/'.$shop->name)}}">{{ __('View') }}</a>
                                                            {{-- <a class="dropdown-item" href="{{url('AdminShop/'.$shop->id.'/edit')}}">{{ __('Edit') }}</a> --}}
                                                            <a class="dropdown-item" onclick="deleteData('AdminShop','{{$shop->id}}');" href="#">{{ __('Delete') }}</a>
                                                        </div>
                                                    </div>
