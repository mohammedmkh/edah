                                ...
                                <div class="col-9">
                                    <div class="tab-content">
                                        ...
                                        <div class="tab-pane" id="language-v">
                                            ...
                                            <div class="row">
                                                <div class="col-3 mb-2 heading-small">Language Name</div>
                                                <div class="col-9 mb-2 heading-small">Status</div>
                                            </div>
                                                ...
                                                <form method="post" action="{{url('saveCommissionSettings')}}" autocomplete="off" enctype="multipart/form-data" >
                                                    ...
                                                    <div>
                                                        {{-- <div class="form-group row {{ $errors->has('commission_amount') ? ' has-danger' : '' }}">
                                                            <div class="col-3">
                                                                <label class="form-control-label" for="input-commission_amount">{{ __('Foodlans Commission') }}<br> {{ __('(In Amount)') }}:</label>
                                                            </div>
                                                            <div class="col-9">
                                                                <input type="number" name="commission_amount" min="0" id="input-commission_amount" class="form-control form-control-alternative{{ $errors->has('commission_amount') ? ' is-invalid' : '' }}" placeholder="{{ __('Foodlans Commission in amount') }}" value="{{ $setting->commission_amount }}" >
                                                        ...
                                                        <div class="form-group row {{ $errors->has('commission_per') ? ' has-danger' : '' }}">
                                                            <div class="col-3">
                                                                <label class="form-control-label" for="input-commission_per">{{ __('Foodlans Commission') }} <br>{{ __('(in Percentage)') }}:</label>
                                                            </div>
                                                            <div class="col-9">
                                                                <input type="number" name="commission_per" min="0" id="input-commission_per" class="form-control form-control-alternative{{ $errors->has('commission_per') ? ' is-invalid' : '' }}" placeholder="{{ __('Foodlans commission in percentage') }}" value="{{ $setting->commission_per }}" >
